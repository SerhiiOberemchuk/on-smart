...
export const brandProductsSchema = mysqlTable(
  "brands_products",
  {
    ...
    brand_slug: varchar("brand_slug", { length: 255 }).notNull().unique(),
  },
  (table) => [uniqueIndex("brand_slug_unique").on(table.brand_slug)],
);
