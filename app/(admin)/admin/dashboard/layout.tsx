...
// type DashboardLink = (typeof dashboardLinks)[number]["href"];
    ...
    <>
      <div className="flex h-svh flex-col">
        <header className="flex items-center justify-between border-b bg-background px-6 py-3">
          ...
          {/* {path.includes("brands") && <ButtonYellow type="button">Додати новий бренд</ButtonYellow>}
          {path.includes("products") && (
            <ButtonYellow type="button">Додати новий товар</ButtonYellow>
          )}
          {path.includes("categories") && (
            <ButtonYellow type="button">Додати нову категорію</ButtonYellow>
          )} */}
