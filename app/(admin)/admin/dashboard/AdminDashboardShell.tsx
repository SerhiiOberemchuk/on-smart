    ...
    case "bundles":
      return (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7">
          ...
          <path d="M4 10h16" />
          <path d="M12 7v13" />
          <path d="M7.5 4h9a1.5 1.5 0 0 1 1.5 1.5V7h-12V5.5A1.5 1.5 0 0 1 7.5 4Z" />
        </svg>
      );
    case "brands":
      return (
    ...
    case "customers":
      return (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7">
          ...
          <path d="M17.5 14.2c1.8.6 3 2.1 3 4.3" />
        </svg>
      );
    case "payments":
      return (
    ...
    <div className="admin-shell">
      <header className="admin-topbar">
        <div className="admin-topbar-left">
          ...
          <Link href={URL_DASHBOARD.DASHBOARD} className="admin-brand">
            OnSmart Адмінка
          </Link>
        </div>
