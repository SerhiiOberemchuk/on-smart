...
export const metadata: Metadata = {
  title: "Prodotto non trovato | OnSmart",
    ...
    <div className="container flex items-center justify-center py-10">
      <div className="mx-auto flex max-w-[600px] flex-col">
        <div className="mx-auto flex items-center text-9xl lg:text-[300px]">
          ...
          <SmartImage
            src="/404.png"
            alt="Illustrazione prodotto non trovato"
        ...
        <h1 className="H2 mt-8 text-center xl:mt-16">Prodotto non trovato.</h1>

        <p className="text_R mt-3 text-center">
          Il prodotto che stai cercando potrebbe essere stato rimosso, rinominato o non più
