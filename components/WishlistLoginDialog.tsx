  ...
  return (
    ...
    >
      <div
        ...
        className="flex w-full max-w-sm flex-col gap-4 rounded-lg bg-background p-6 text-center"
      >
        ...
        <div className="flex flex-col gap-2">
          <Link
            ...
            className="rounded-md bg-yellow-500 px-4 py-3 font-medium text-black transition hover:bg-yellow-400"
            onClick={close}
          >
            Accedi
          </Link>
          <Link
            ...
            className="rounded-md border border-stroke-grey px-4 py-3 transition hover:bg-black/5"
            onClick={close}
          >
            Registrati
          </Link>
