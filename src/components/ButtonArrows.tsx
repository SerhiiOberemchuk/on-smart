...
export function ButtonArrowLeft({ onClick }: ArrowButtonProps) {
  return (
    <button type="button" onClick={onClick} className="h-12 w-12 cursor-pointer">
      <svg
        width="48"
        height="48"
        viewBox="0 0 48 48"
...
export function ButtonArrowRight({ onClick }: ArrowButtonProps) {
  return (
    <button type="button" onClick={onClick} className="w-12">
      <svg
        width="48"
        height="48"
        viewBox="0 0 48 48"
