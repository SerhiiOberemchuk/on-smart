export default function Search() {
  ...
  return (
    <form action={action} className="relative mx-6 w-full max-w-[440px]">
      ...
      <input
        ...
        name="search"
        placeholder="Cerca..."
        className="w-full rounded border border-stroke-grey py-2.5 pl-12 font-normal text-white placeholder:text-white autofill:bg-blue-700 focus:ring-2 focus:ring-yellow-600 focus:outline-none"
      />
    </form>
  );
}
